...
export const COACH = {
  ...
  story: [
    'بدأ بدر سامي الجبور مسيرته في تعليم القيادة عام ٢٠٠٨، بعد سنوات من العمل في القيادة المهنية على الطرق الخارجية والشاحنات. هذه الخلفية العملية هي ما يميّز تدريبه: الطالب لا يتعلّم كيف ينجح في الاختبار فقط، بل كيف يتصرّف في المطر، في الازدحام، على المنحدرات، وفي اللحظة التي يخطئ فيها سائق آخر.',
