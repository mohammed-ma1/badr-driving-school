...
export class TheoryComponent implements OnDestroy {
  ...
  answer(optionIndex: number): void {
    // One shot per question: the result is revealed immediately, so allowing a
    // change afterwards would let the student correct themselves for free.
    ...
    if (optionIndex === this.current().answer) {
